...
from tests.data import get_santander_data_from_file
...
class TestLote(unittest.TestCase):
    ...
    def setUp(self):
        santander_data = get_santander_data_from_file()
        self.lote = santander_data['lote_cob']
        self.evento_1 = santander_data['evento_cob1']
        self.evento_2 = santander_data['evento_cob2']
        self.remessa = santander_data['remessa']
